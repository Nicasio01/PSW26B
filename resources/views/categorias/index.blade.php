...
<div class="max-w-screen-xl mx-auto p-4 mt-20">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('categorias.create') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5">Nueva Categoría</a>
    </div>
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">Tecnología de la Información</td>
                    <td class="px-6 py-4">Soporte técnico, desarrollo de software y administración de redes.</td>
